# $isDeaf
> <img align="top" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Infobox_info_icon.svg/160px-Infobox_info_icon.svg.png?20150409153300" alt="image" width="25" height="auto"> Returns whether a member is deafened
## Usage
```
$isDeaf
```
...
export default new NativeFunction({
    ...
    execute(ctx, [, member]) {
        member ??= ctx.member!
        return this.success(member?.voice.deaf ?? false)
    },
})
