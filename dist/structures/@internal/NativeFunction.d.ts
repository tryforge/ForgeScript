import { ApplicationEmoji, AttachmentBuilder, AutoModerationRule, BaseChannel, Emoji, Guild, GuildEmoji, GuildForumTag, GuildMember, GuildScheduledEvent, Invite, Message, MessageReaction, PermissionsString, Role, StageInstance, Sticker, TextBasedChannel, User, Webhook } from "discord.js";
