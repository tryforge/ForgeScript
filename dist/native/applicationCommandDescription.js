...
exports.default = new structures_1.NativeFunction({
    ...
    async execute(ctx, [id]) {
        if (this.hasFields) {
            ...
            return structures_1.Return.success(command ? command.description : undefined);
        }
        return structures_1.Return.success(ctx.interaction?.isCommand() ? ctx.interaction.command?.description : undefined);
    },
});
