...
exports.default = new structures_1.NativeFunction({
    ...
    async execute(ctx, [channel, roleOrUser, raw]) {
        ...
        if (ch.permissionOverwrites.cache.has(roleOrUser.id)) {
            return this.success(!!(await ch.permissionOverwrites.edit(roleOrUser, mapped).catch(noop_1.default)));
        }
        else {
            return this.success(!!(await ch.permissionOverwrites.create(roleOrUser, mapped).catch(noop_1.default)));
        }
    },
});
