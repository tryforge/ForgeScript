...
Make sure you have <strong>node.js</strong> installed, and greater than or equal to version **v22.0.0**. Once done, run one of the following commands in a console (from any IDE or terminal):
